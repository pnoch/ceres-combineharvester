...
from ceres.plotting.util import PlotInfo, parse_plot_info
from ceres.protocols import harvester_protocol
from ceres.protocols.farmer_protocol import FarmingInfo
from ceres.protocols.harvester_protocol import Plot
from ceres.protocols.protocol_message_types import ProtocolMessageTypes
from ceres.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        ...
        self.harvester.log.info(
            f"({coin_name + ')':10}: {len(awaitables)} plots were eligible for farming {new_challenge.challenge_hash.hex()[:10]}..."
