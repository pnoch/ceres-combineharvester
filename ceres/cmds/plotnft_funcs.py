...
from ceres.cmds.units import units
from ceres.cmds.wallet_funcs import print_balance, wallet_coin_unit
...
from ceres.util.ints import uint16, uint32, uint64
        ...
        try:
            ...
            while time.time() - start < 10:
                ...
                if len(tx.sent_to) > 0:
                    ...
                    print(f"Do ceres wallet get_transaction -f {fingerprint} -tx 0x{tx_record.name} to get status")
                    return None
        except Exception as e:
