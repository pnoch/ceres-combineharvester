...
from ceres.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from ceres.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from ceres.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from ceres.pools.pool_puzzles import (
...
from ceres.util.ints import uint8, uint32, uint64
from ceres.wallet.derive_keys import (
    master_sk_to_pooling_authentication_sk,
    find_owner_sk,
)
from ceres.wallet.sign_coin_spends import sign_coin_spends
from ceres.wallet.transaction_record import TransactionRecord
from ceres.wallet.util.wallet_types import WalletType
from ceres.wallet.wallet import Wallet
from ceres.wallet.wallet_coin_record import WalletCoinRecord

from ceres.wallet.wallet_info import WalletInfo
from ceres.wallet.util.transaction_type import TransactionType
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `ceres singleton` that is
